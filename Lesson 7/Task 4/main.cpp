...
{
public:
	Graph(int v) : v(v), comp(), visited(nullptr), previousVertex(0), isCyclic(false)
	{
		matrix = new int* [v] {};
	...
	void printComponents()
	{
		...
		for (int idxVertex{}; idxVertex < v; idxVertex++)
		{
			...
			std::cout << (idxVertex + 1) << " - " << components[idxVertex] << std::endl;
		}

		std::cout << "Количество компонентов связности в графе: " << comp << std::endl;
